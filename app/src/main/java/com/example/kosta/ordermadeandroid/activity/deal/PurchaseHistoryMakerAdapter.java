...
public class PurchaseHistoryMakerAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView requestTitle = (TextView)convertView.findViewById(R.id.requestTitle);
        ...
        Button delivery = (Button)convertView.findViewById(R.id.delivery);

        final PurchaseHistory purchaseHistory = purchaseHistoryList.get(position);
        consumerId.setText(purchaseHistory.getConsumer().getId());
        requestTitle.setText(purchaseHistory.getRequest().getTitle());
        purchaseDate.setText(purchaseHistory.getOrderDate());

        if(purchaseHistory.getDeliveryStatus().equals(Constants.DELIVERY_PREPARE)){
            progressStatus.setText("배송준비중");
            delivery.setText("상품배송");
        } else if(purchaseHistory.getDeliveryStatus().equals(Constants.DELIVERY_COMPLETE)) {
            progressStatus.setText("배송완료");
            delivery.setText("배송완료");
